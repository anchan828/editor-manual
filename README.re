 ...
 *** @<href>{https://gist.github.com/anchan828/4af242328bbdfbfd6c41,エディタ再生時にiTunesを一時停止＆エディタ再生をやめた時にiTunesを再生する}
 *** @<href>{https://gist.github.com/anchan828/13c901d5daa9f7502d65,コンパイルエラーが出たまま再生ボタンを押すと、ドラクエの呪いの効果音を再生する}
 * AnimatorController
 * Callbacks
 ...
 * ObjectPicker
 * ScriptTemplates
 ** @<b>{using UnityEditor;}を追加したスクリプトファイル
 ** @<b>{GetWindow}を追加したEditorWindowファイル@<br>{}
