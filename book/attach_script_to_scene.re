...
もしシーンファイルにスクリプトをアタッチすることが出来るのであれば、管理クラスのためにゲームオブジェクトを作成する必要がなくなります。それ以外は特に大きな変化はありませんが「もしかすると」こちらのほうが管理のイメージが楽になり、ミスも減るかもしれません。@<fn>{1}
...
通常はシーンアセットにコンポーネントをアタッチすることは出来ません。また、エディタ拡張によってシーンアセットにコンポーネント情報を追加することも出来ません。
