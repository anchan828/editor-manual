...
@<chapref>{gizmo}にて、オブジェクトの位置や範囲、特定の要素を可視化するための仕組みを紹介しました。本章では、さらに込み入った可視化、それだけではなく「@<b>{操作}」を行う @<b>{Handles} について紹介していきます。
...
//image[ss08][四角の中でドラッグすると動かすことができる]{
...
//image[ss15][ナビゲーションウィンドウを開いている時に右下に GUI が表示されている][scale=0.5]{
