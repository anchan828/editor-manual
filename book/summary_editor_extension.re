...
アセットストアでアセットを購入してもいいし、そのアイデアを元に社内向けに自作してもいいかもしれません。残りの2割をこのようにして補うことで、ユーザーやプロジェクトごとに最適化されたUnityエディターが完成します。
...
アセットストアにあるエディター拡張系のアセットを使うと、すぐに便利なUnityエディターになります。ですが「（チーム・会社の都合上で）ここをもうちょっとこうしたい！」となることが多くなるのも事実です。アセットストアのものは汎用的なものになりがちで、少し特殊な環境に置かれているプロジェクトになると、途端に使いづらくなってしまいます。
