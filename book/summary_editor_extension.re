...
アセットストアでアセットを購入してもいいし、そのアイデアを元に社内向けに自作してもいいかもしれません。
残りの2割をこのようにして補うことで、ユーザーやプロジェクトごとに最適化されたUnityエディターが完成します。
...
エディター拡張の開発作業は楽しいです。「Cube に Rigidbody をアタッチしたら重力で下に落ちていく」というようなランタイム側で経験する、@<b>{実装したらすぐに結果を見ることが出来る楽しさ}をエディター拡張でも味わうことが出来ます。
...
アセットストアにあるエディター拡張系のアセットを使うと、すぐに便利なUnityエディターになります。ですが「（チーム・会社の都合上で）ここをもうちょっとこうしたい！」となることが多くなるのも事実です。アセットストアのものは汎用的なものになりがちで、少し特殊な環境に置かれているプロジェクトになると、途端に使いづらくなってしまいます。その解決としてソースに手を加えたい場合、もちろんエディター拡張の知識が必要になります。知識さえあれば、他人のソースでも自ずと修正すべき箇所が見えてくるはずです。
